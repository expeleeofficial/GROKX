        ...
        <div>
            <div className="bg-gray-900 flex flex-col justify-center items-center p-2">
                <div className="grid grid-rows-3 gap-4 w-[40%] h-full">
                    <div
                        className="flex flex-col bg-gray-200 w-full row-span-2 h-96 p-2 rounded-xl">
                        ...
                        <div className="h-full w-full px-4 mx-auto bg-gray-800 rounded-lg p-2">
                            <div
                                className=" mx-auto rounded-lg py-1 px-2 border border-gray-400 flex justify-between items-center">
                            ...
                            <div
                                className=" mx-auto my-2 h-7 rounded-lg flex justify-center items-center bg-gray-500">
                                Submit
                            </div>
                            <div className="space-y-2">
                                <div className="flex justify-between text-light items-center">
