...
const Roadmap = () => {
  return (
    <>
    <div class="md:min-h-screen bg-black py-6 flex flex-col justify-center sm:py-12">
    <h1 class="text-2xl font-semibold text-center text-gray-300 capitalize lg:text-3xl pb-10 dark:text-white">ROADMAP</h1>
      ...
      <div class="mt-6 sm:mt-0 sm:mb-12">
        <div class="flex flex-col sm:flex-row items-center">
          <div class="flex justify-start w-full mx-auto items-center">
           ...
           <li>army of grok x</li>
           <li>Hype Marketing campaign</li>
           </ul>
              </div>
            </div>
          </div>
        ...
        <div class="flex flex-col sm:flex-row items-center">
          <div class="flex justify-end w-full mx-auto items-center">
            <div class="w-full sm:w-1/2 sm:pl-8">
              ...
              <li>CGC/CM Listings</li>
              <li>nft development</li>
              <li>Tier 3 CEX Listings </li>
              <li>1m marketcap</li>
              </ul>
              </div>
            </div>
        ...
        <div class="flex flex-col sm:flex-row items-center">
          <div class="flex justify-start w-full mx-auto items-center">
            <div class="w-full sm:w-1/2 sm:pr-8">
              ...
              <li>Top Cex Listings </li>
              <li>ads campaign </li>
              <li>trending campaign</li>
